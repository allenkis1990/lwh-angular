...
define(function () {
    var PDFObject = function (obj) {
        ...
        if (pluginTypeFound == null) {
            var container = document.getElementById(id);
            if (obj.downLoadUrl) {
                container.src = obj.downLoadUrl;
            }
            else {
                var parentContainer = document.getElementById(id).parentElement;
                var divContainer = document.createElement("div");
                // divContainer.width = container.width;
                // divContainer.height = container.height;
                divContainer.className += container.className;
                var title0 = document.createElement("h4");
                var title1 = document.createElement("h4");
                title0.innerHTML = "我们需要Adobe Acrobat Reader DC来播放PDF文档";
                title1.innerHTML = "请点击下载最新的Adobe Acrobat Reader";

                divContainer.appendChild(title0);
                divContainer.appendChild(title1);

                var adobeRemoteFont = document.createElement("p");
                adobeRemoteFont.innerHTML = "官网下载";
                var adobeRemotePdfLink = document.createElement("a");
                adobeRemotePdfLink.href = "https://get.adobe.com/cn/reader/";
                adobeRemotePdfLink.target = "_blank";
                adobeRemotePdfLink.appendChild(adobeRemoteFont);

                var adobeFont = document.createElement("p");
                adobeFont.innerHTML = "本地下载";
                var adobePdfLink = document.createElement("a");
                adobePdfLink.href = obj.downLoadFileUrl;
                adobePdfLink.target = "_blank";
                adobePdfLink.appendChild(adobeFont);

                divContainer.appendChild(adobeRemotePdfLink);
                divContainer.appendChild(adobePdfLink);

                parentContainer.insertBefore(divContainer, parentContainer.firstChild);
        ...
        this.pluginTypeFound = pluginTypeFound;
        return this;
